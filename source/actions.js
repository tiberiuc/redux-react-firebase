        ...
        queryParams.forEach((param) => {
            ...
            switch (param[0]) {
                ...
                case 'limitToLast':
                    ...
                    break
                case 'equalTo':
                    let equalToParam = (!doNotParse && Number.isInteger(param[1])) ? parseInt(param[1]) : param[1]
                    ...
                    break
                case 'startAt':
                    let startAtParam = (!doNotParse && Number.isInteger(param[1])) ? parseInt(param[1]) : param[1]
                    ...
                    break
                case 'endAt':
                    let endAtParam = (!doNotParse && Number.isInteger(param[1])) ? parseInt(param[1]) : param[1]
